...
<?php endif; ?>
                <?php else: ?>
                    <div class="space-x-4">
                        <a href="<?php echo e(route('login')); ?>" class="text-sm text-gray-700 hover:text-gray-900">Log in</a>
                        <a href="<?php echo e(route('register')); ?>" class="ml-4 text-sm text-gray-700 hover:text-gray-900">Register</a>
                    </div>
                <?php endif; ?>
            </div>
...
</nav><?php /**PATH C:\xampp\htdocs\my_cookies\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>