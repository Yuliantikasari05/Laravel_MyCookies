...
<head>
    ...
    <title><?php echo e(config('app.name', 'My Cookies')); ?></title>
                ...
                <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex-shrink-0">
                        <a href="/" class="flex items-center space-x-2">
                            ...
                            <img src="<?php echo e(asset('assets/logo.png')); ?>" alt="Logo My Cookies" class="h-10 w-10 object-contain">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative" x-data="{ isOpen: false }">
                            ...
                            <div x-show="isOpen" 
                                ...
                                <?php else: ?>
                                    <!-- Login Link -->
                                    <a href="<?php echo e(route('login')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-amber-50">
                                        <i class="fas fa-sign-in-alt mr-2"></i>Login
                                    </a>

                                    <!-- Register Link -->
                                    <a href="<?php echo e(route('register')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-amber-50">
...
<?php /**PATH C:\xampp\htdocs\my_cookies\resources\views/layouts/app.blade.php ENDPATH**/ ?>