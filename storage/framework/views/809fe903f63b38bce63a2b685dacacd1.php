            ...
            <div class="bg-white/80 backdrop-blur-sm shadow-lg rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300">
                <div class="p-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                        ...
                        <div class="space-y-6">
                            <div>
                                <h1 class="text-3xl font-bold text-amber-900 mb-2"><?php echo e($product->name); ?></h1>
                                ...
                                <p class="text-amber-700 leading-relaxed mb-6"><?php echo e($product->description); ?></p>
                            </div>

                            <div class="border-t border-amber-100 pt-6">
                                <div class="flex items-baseline mb-4">
                                    <span class="text-3xl font-bold text-amber-900">Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?></span>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\my_cookies\resources\views/products/show.blade.php ENDPATH**/ ?>